...
datfd = read_csv("Data/well_fracking_direct_water_reported.csv", col_types = c(County = "c", Year = "i"))
datcd = read_csv("Data/well_cementing_direct_water_estimated.csv", col_types = c(County = "c", Year = "i"))
datdd = read_csv("Data/well_drilling_direct_water_estimated.csv", col_types = c(County = "c", Year = "i"))
